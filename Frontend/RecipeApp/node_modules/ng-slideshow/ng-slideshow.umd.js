(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@ngrx/store/index'), require('immutable'), require('@angular/platform-browser'), require('@angular/common'), require('hammerjs'), require('ng2-truncate/dist/index')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@ngrx/store/index', 'immutable', '@angular/platform-browser', '@angular/common', 'hammerjs', 'ng2-truncate/dist/index'], factory) :
	(factory((global['ng-slideshow'] = global['ng-slideshow'] || {}),global._angular_core,global._ngrx_store_index,global.Immutable,global._angular_platformBrowser,global._angular_common,null,global.ng2Truncate_dist_index));
}(this, (function (exports,_angular_core,_ngrx_store_index,Immutable,_angular_platformBrowser,_angular_common,hammerjs,ng2Truncate_dist_index) { 'use strict';
...
var SlideshowComponent = (function () {
    ...
    function SlideshowComponent(domSanitizer, store, elementRef, zone) {
         ...
         *
         */
        this.eventDispatcher = new _angular_core.EventEmitter();
        /**
         * Thumbnail offset
         *
         */
...
SlideshowComponent.propDecorators = {
    ...
    'eventDispatcher': [{ type: _angular_core.Output },],
};

var reducers = { state: stateReducer, index: indexReducer };
var productionReducer = _ngrx_store_index.combineReducers(reducers);
/**
 * @param {?} state
 * @param {?} action
 * @return {?}
...
SlideshowModule.decorators = [
    { type: _angular_core.NgModule, args: [{
                imports: [
                    ...
                    ng2Truncate_dist_index.TruncateModule,
                    _ngrx_store_index.StoreModule.provideStore(reducer)
                ],
